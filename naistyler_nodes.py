...
class NaiStylerComplexCSVLoader:
    ...
    def load_naifilters_csv(naifilters_path: str):
        ...
        Returns:
            list: List of naifilters. Each style is a dict with keys: style_name and value: [positive_prompt, negative_prompt]
        """
    ...
    def load_naitypes_csv(naitypes_path: str):
        """Loads filtercsv file, Ignore the first row (header).
        Returns:
            list: List of naitypes. Each style is a dict with keys: style_name and value: [positive_prompt, negative_prompt]
        """
